...
Officer: 4700213
CaseNum: 303-0-37482786-4700213
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make Cryptic_Locker_Value_A equal to 18

	Whilst the mouse is being dragged:
	- Make Cryptic_Locker_Value_A equal to 17

	Whilst the mouse is moving:
	- Make Cryptic_Locker_Value_A equal to 23

	When the mouse button is released:
	- Make Cryptic_Locker_Value_A equal to 14

	When the mouse button is released:
	- Make Cryptic_Locker_Value_B equal to 0

	When the mouse button is pressed:
	- Make Cryptic_Locker_Value_B equal to 9

	When any key is released:
	- Make Cryptic_Locker_Value_B equal to 56

	When any key is pressed:
	- Make Cryptic_Locker_Value_B equal to 5
...
var Cryptic_Locker_Value_A;
var Cryptic_Locker_Value_B;
...
function setup()
{
	...
	Cryptic_Locker_Value_A = 0;
	Cryptic_Locker_Value_B = 0;
...
function draw()
{
	...
	drawDial(200, Cryptic_Locker_Value_A, 36);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(Cryptic_Locker_Value_B);
	pop();
